...
const JoinPage:NextPage=()=>{
    ...
    const url=`${API.SERVER}/userSave`
    const data={'username':username, 'password':password, 'name':name, 'phone':phone, 'addressId':addressId, 'recommender':recommender}
...
<form>
    ...
    <br/>
    <label htmlFor="psw-repeat"><b>recommender</b></label>
